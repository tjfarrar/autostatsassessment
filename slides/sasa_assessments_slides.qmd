...
-   [Mentimeter Slides](https://www.mentimeter.com/app/presentation/alrbofmauaoakh5z36zf1isnr2pxwnyc/edit?question=s33qsd33xjf2) (link will only work for presenter)
...
![](../images/lecture05_Rmarkdown01.png){height="80%"}

## Creating an R Markdown file

![](../images/lecture05_Rmarkdown02.png){height="80%"}
...
![](../images/lecture05_quarto01.png){height="80%"} 
...
![](../images/lecture05_quarto02.png){height="80%"} 
...
![](../images/lecture05_sweave01.png){height="80%"} 
...
![](../images/lecture05_sweave02.png){height="80%"} 
...
![](../images/lecture05_Rmarkdown03.png){height="70%"}
...
library(tidyverse)
library(readxl)
corolla <- read_excel("surf4cars_Toyota_Corolla.xlsx") %>% 
