...
- Morning: PDF (e.g., paper-based) assessments
- Afternoon: Learning Management System (LMS) assessments
...
![](images/github.png){height=360}


- The [templates](https://github.com/tjfarrar/autostatsassessment/tree/main/templates) folder contains many useful templates and source files
...
-   One-click compilation of R code **and** output document/s (e.g., question paper and memorandum)
