...
========
 ...
 The `r rvtype` random variable $X$ has the following probability `r ifelse(rvtype == "discrete", "mass", "density")` function:
 
 \begin{eqnarray*}
 f_X(x)&=\begin{cases} `r flatex` \text{ for } `r supportlatex` \\
 0 \text{ otherwise}
...
exstringtype: essay
exsolution: nil
exname: `r paste0("Expectation_", Sys.Date(), "_Rmd")`
