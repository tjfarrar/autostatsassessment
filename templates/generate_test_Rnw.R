...
test_questions_Rnw <- list("capital_cities.Rnw",
                           "two_numbers.Rnw",
                           "calculate_gradient.Rnw",
                           "calculate_lotto.Rnw",
                           "upload_scatterplot.Rnw",
                           "upload_expectation.Rnw")

# It is VERY important to set the seed here
set.seed(myseed)

# Generate an HTML version of the test for preview purposes
exams2html(file = test_questions_Rnw, n = maxn, 
           mathjax = TRUE, converter = "pandoc-mathjax", 
           solution = TRUE,
           name = "Example_Test_1_", dir = "ExampleTest1_Rnw")
...
exams2blackboard(file = test_questions_Rnw, n = maxn, 
                 mathjax = FALSE, 
                 name = "Example_Test_1_", dir = "ExampleTest1_Rnw")
